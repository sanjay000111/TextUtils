...
export default function About(props) {
    ...
    <div>
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            Textutils gives you a way to analyze your text quickly and efficiently. Be it word count, character count or convert text to desired case, copy text and remove the extra spaces.
            </div>
            </div>
        </div>
        <div className="accordion-item" style={myStyle}>
